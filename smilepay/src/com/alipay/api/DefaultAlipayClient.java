...
public class DefaultAlipayClient implements AlipayClient {
     ...
     * @return
     */
    private <T extends AlipayResponse> RequestParametersHolderSmilePay getRequestHolderWithSign(AlipayRequest<?> request,
                                                                                                String accessToken,
                                                                                                String appAuthToken)
        throws AlipayApiException {
        RequestParametersHolderSmilePay requestHolder = new RequestParametersHolderSmilePay();

        AlipayHashMapSmilePay appParams = new AlipayHashMapSmilePay(request.getTextParams());
        ...
        AlipayHashMapSmilePay protocalMustParams = new AlipayHashMapSmilePay();
        ...
        AlipayHashMapSmilePay protocalOptParams = new AlipayHashMapSmilePay();
        ...
        if (!TextUtils.isEmpty(this.sign_type)) {
            ...
            String signContent = AlipaySignatureSmilePay.getSignatureContent(requestHolder);
            Log.i("Test", "signContent:" + signContent);
            try {

                protocalMustParams.put(AlipayConstants.SIGN,
                    AlipaySignatureSmilePay.rsaSign(signContent, privateKey, charset, this.sign_type));
    ...
    private <T extends AlipayResponse> void doPost(final AlipayRequest<T> request,
        ...
        final RequestParametersHolderSmilePay requestHolder = getRequestHolderWithSign(request, accessToken,
            appAuthToken);
